const Sidebar = () => {
  return (
    <div className="w-full rounded-lg border shadow-sm overflow-hidden bg-white border-stone-200 shadow-stone-950/5 max-w-[280px]">
      <div className="w-[calc(100%-16px)] rounded m-2 mx-3 mb-0 mt-3 flex h-max items-center gap-2">
        <img
          ...
          alt="brand"
          className="inline-block object-cover object-center w-6 h-6 rounded-sm"
        />
        ...
        <ul className="flex flex-col gap-0.5 min-w-60">
          ...
          <li>
            <div
              ...
              data-dui-target="#sidebarWithLogoCollapseList"
              aria-expanded="false"
              aria-controls="sidebarWithLogoCollapseList"
              className="flex items-center justify-between min-w-60 cursor-pointer py-1.5 px-2.5 rounded-md align-middle transition-all duration-300 ease-in text-stone-600 hover:text-stone-800 dark:text-stone-300 dark:hover:text-white hover:bg-stone-200 dark:hover:bg-stone-700 focus:bg-stone-200 dark:focus:bg-stone-700 focus:text-stone-800 dark:focus:text-white"
            >
              ...
              <span
                data-dui-icon
                className="grid place-items-center shrink-0 transition-transform duration-300 ease-in-out"
              >
                <svg
                  width="1.5em"
                  height="1.5em"
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                  color="currentColor"
                  className="h-4 w-4 stroke-[1.5] dark:stroke-stone-300"
                >
                  <path
                    d="M6 9L12 15L18 9"
                    stroke="currentColor"
            ...
            <div
              ...
              id="sidebarWithLogoCollapseList"
            >
              <ul className="flex flex-col gap-0.5 min-w-60">
                <li className="pl-10 flex items-center cursor-pointer py-1.5 px-2.5 rounded-md align-middle select-none font-sans transition-all duration-300 ease-in bg-transparent text-stone-600 hover:text-stone-800 dark:text-stone-300 dark:hover:text-white hover:bg-stone-200 dark:hover:bg-stone-700 focus:bg-stone-200 dark:focus:bg-stone-700 focus:text-stone-800 dark:focus:text-white">
                  Inbox
                </li>
                <li className="pl-10 flex items-center cursor-pointer py-1.5 px-2.5 rounded-md align-middle select-none font-sans transition-all duration-300 ease-in bg-transparent text-stone-600 hover:text-stone-800 dark:text-stone-300 dark:hover:text-white hover:bg-stone-200 dark:hover:bg-stone-700 focus:bg-stone-200 dark:focus:bg-stone-700 focus:text-stone-800 dark:focus:text-white">
                  Trash
      ...
      <div className="w-full px-3.5 pt-2 pb-3.5 rounded mt-8">
        <div className="w-full rounded-lg border overflow-hidden bg-stone-800 border-stone-950 shadow-stone-950/25 shadow-none">
          <div className="w-[calc(100%-16px)] h-max rounded m-3">
            <svg
              width="1.5em"
              height="1.5em"
              stroke-width="1.5"
          ...
          <div className="w-full h-max rounded px-3.5 py-2.5">
            <h6 className="font-sans antialiased font-bold text-base md:text-lg lg:text-xl mb-1 text-white">
              Upgrade to PRO
            </h6>
            <small className="font-sans antialiased text-sm text-white/80">
