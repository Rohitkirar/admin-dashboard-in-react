  ...
  return (
    <nav className="rounded-lg border shadow-lg overflow-hidden p-2 bg-white border-stone-200 shadow-stone-950/5 mx-auto w-full max-w-screen-xl">
      <div className="flex items-center">
        <a
          href="#"
          className="font-sans antialiased text-sm text-current ml-2 mr-2 block py-1 font-semibold"
        >
          Material Tailwind
        </a>
          ...
          <div className="min-w-60 mt-4 flex flex-col gap-1 lg:mt-0 lg:flex-row lg:items-center">
            <div className="dropdown" data-dui-placement="bottom-start">
              ...
              >
                ...
                <span className="grid place-items-center shrink-0 ps-2.5 ms-auto ps-0.5">
                  <svg
                    width="1.5em"
                    height="1.5em"
                    stroke-width="1.5"
        ...
        <button
          ...
          data-dui-target="#navbar-collapse"
          aria-expanded="false"
        ...
        <img
          ...
          alt="profile-picture"
          className="inline-block object-cover object-center w-8 h-8 rounded outline-none group border border-stone-800 p-0.5 lg:ml-auto"
        />
      </div>
      <div
        className="overflow-scroll transition-[max-height] duration-300 ease-in-out max-h-0 lg:hidden"
        id="navbar-collapse"
      >
        <div className="min-w-60 mt-4 flex flex-col gap-1">
          ...
          >
            ...
            <span
              data-dui-icon
              className="grid place-items-center shrink-0 ms-auto transition-transform duration-300 ease-in-out"
            >
              <svg
                width="1.5em"
                height="1.5em"
          ...
          >
            <ul className="flex flex-col gap-0.5 min-w-60">
              <li className="flex items-center py-1.5 px-2.5 rounded-md align-middle select-none font-sans transition-all duration-300 ease-in aria-disabled:opacity-50 aria-disabled:pointer-events-none bg-transparent text-stone-600 hover:text-stone-800 dark:hover:text-white hover:bg-stone-200 focus:bg-stone-200 focus:text-stone-800 dark:focus:text-white dark:data-[selected=true]:text-white dark:bg-opacity-70">
                <small className="font-sans antialiased text-sm text-current pl-7">
                  Landing Page
                </small>
              </li>
              <li className="flex items-center py-1.5 px-2.5 rounded-md align-middle select-none font-sans transition-all duration-300 ease-in aria-disabled:opacity-50 aria-disabled:pointer-events-none bg-transparent text-stone-600 hover:text-stone-800 dark:hover:text-white hover:bg-stone-200 focus:bg-stone-200 focus:text-stone-800 dark:focus:text-white dark:data-[selected=true]:text-white dark:bg-opacity-70">
