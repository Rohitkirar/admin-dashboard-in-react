const socialIconClass =
  "inline-grid place-items-center min-w-[34px] min-h-[34px] rounded-md text-stone-600 hover:bg-stone-100 hover:text-stone-900 transition-colors duration-150";

const linkClass =
  "font-sans antialiased text-sm text-stone-600 py-1 hover:text-stone-900 transition-colors duration-150 block";
      ...
      <div className="mx-auto w-full max-w-7xl px-8">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
          ...
          <div className="grid grid-cols-3 justify-between gap-x-6 gap-y-4">
            {/* Product */}
            <div>
              <p className="font-sans antialiased text-sm font-semibold text-stone-400 mb-2 uppercase tracking-wide">
                Product
              </p>
              <ul className="flex flex-col gap-0.5">
                {["Overview", "Features", "Solutions", "Tutorials"].map(
                  (item) => (
                    <li key={item}>
        ...
        <div className="mt-10 flex w-full flex-col items-center justify-center gap-4 border-t border-stone-200 py-4 md:flex-row md:justify-between">
          <small className="font-sans antialiased text-sm text-stone-500 text-center">
            © 2024{" "}
            <a
          ...
          <div className="flex gap-1 sm:justify-center">
            ...
            {/* X / Twitter */}
            <a href="#" className={socialIconClass} aria-label="X">
              <svg
                width="1em"
                height="1em"
                strokeWidth="1.5"
            ...
            {/* Web / Globe */}
            <a href="#" className={socialIconClass} aria-label="Website">
              <svg
                width="1em"
                height="1em"
                strokeWidth="1.5"
                ...
                className="h-4 w-4"
              >
                <path d="M2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12Z"></path>
                <path d="M16.6726 20.8435C15.5 14 12.5 8.00003 8.5 2.62964"></path>
                <path d="M2.06653 10.8406C6.00004 11 15.2829 10.5 19.1415 5"></path>
                <path d="M21.9677 12.81C15.3438 10.8407 7.50002 14.0001 5.23145 19.3613"></path>
              </svg>
            </a>
          </div>
        </div>
